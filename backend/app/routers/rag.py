...
DOCTORS = {
    ...
    "joshua_wright_chisem": {
        "id": "joshua_wright_chisem",
        "name": "Dr. Joshua Wright-Chisem",
        "specialty": "Orthopedic Surgery - Sports Medicine",
        "procedures": ["ucl", "acl", "rotator_cuff", "meniscus"]
    },
    "brian_cole": {
...
COLLECTION_PERMISSIONS = {
    # RCT Documents
    "dr_general_ucl_rct": ["joshua_dines", "asheesh_bedi", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "steven_defroda", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_rotator_cuff_rct": ["joshua_dines", "asheesh_bedi", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "steven_defroda", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_meniscus_rct": ["joshua_dines", "asheesh_bedi", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "steven_defroda", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_acl_rct": ["joshua_dines", "asheesh_bedi", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "steven_defroda", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    ...
    "dr_general_knee_lower_leg": ["william_long", "khalid_alkhelaifi", "jorge_chahla", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_foot_ankle": [],  # CareGuide only
    "dr_general_shoulder": ["joshua_dines", "asheesh_bedi", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "steven_defroda", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_elbow": ["joshua_dines", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_hip_thigh": ["asheesh_bedi", "william_long", "jorge_chahla", "steven_defroda", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    ...
    "dr_general_shoulder_replacement_reviews": ["joshua_dines", "asheesh_bedi", "steven_defroda", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "lafi_khalil", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],
    "dr_general_fai_reviews": ["asheesh_bedi", "steven_defroda", "ayoosh_pareek", "khalid_alkhelaifi", "jorge_chahla", "lafi_khalil", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],

    # Shoulder Replacement RCTs
    "dr_general_shoulder_replacement_rct": ["joshua_dines", "lafi_khalil", "asheesh_bedi", "steven_defroda", "ayoosh_pareek", "khalid_alkhelaifi", "matt_fury", "nicholas_colyvas", "shane_nho", "joshua_wright_chisem", "brian_cole", "scott_sigman"],

    # Research Papers
    "dr_general_defroda_pubmed": ["steven_defroda"],
    "dr_general_long_pubmed": ["william_long"],
